...
//constructor
    ...
    private void leerDatos() { //recupera los datos principales del usuario
...
//dependiendo del numero dcon el que inicia la cuenta:
    ...
    public void cambiarIdioma(String idioma) { //para que este en el idioma pedido
        Locale locale = new Locale(idioma);
        recursos = ResourceBundle.getBundle("textos", locale);
